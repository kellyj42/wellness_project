      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-light text-[#2E2A26] mb-6">
            Client{" "}
            <span className="text-[#A3AD5F] font-normal">Transformations</span>
          </h2>
          <p className="max-w-3xl mx-auto text-lg text-[#5B544D]">
            Real stories from clients who have transformed their lives with
        ...
        >
          {clients.map((client, index) => (
            ...
            >
              {/* Client Image */}
              <div className="relative h-64 w-full bg-gradient-to-br from-[#A3AD5F]/20 to-[#5B544D]/20">
                <Image
                  src={client.image}
                  alt={client.name}
                  fill
              ...
              <div className="p-6">
                ...
                <p className="text-[#5B544D] text-sm leading-relaxed mb-4 italic whitespace-pre-wrap">
                  ...
                  {expandedClients[client.id]
                    ? client.feedback
                    : `${client.feedback.substring(0, 120)}...`}
                  &quot;
                </p>
